...
open class FolioReaderConfig: NSObject {
    ...
    /// Days mode background color
    open var daysModeBackground = UIColor(rgba: "#F5EFDD")
    ...
    open var localizedReaderOneChapterLeft = NSLocalizedString("1 chapter left", comment: "")
    open var localizedReaderManyChaptersLeft = NSLocalizedString("chapters left", comment: "")
